...
export default function Footer() {
  return (
    <footer className="py-16 px-6 bg-zinc-950 border-t border-zinc-800">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          {/* Brand */}
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-emerald-400 to-cyan-400">
              UAE7Guard
            </h3>
            <p className="text-zinc-400 mb-6 max-w-md">
              Enterprise-grade Web3 security platform providing real-time threat detection and risk assessment for blockchain transactions.
            </p>
            <div className="flex gap-4">
              <a href="#" className="w-10 h-10 rounded-lg bg-zinc-900 border border-zinc-800 flex items-center justify-center hover:border-emerald-500 transition-colors">
