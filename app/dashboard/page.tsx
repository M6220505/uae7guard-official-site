...
function TransactionSimulatorPanel({ address }: { address?: string }) {
  ...
  const examples = [
    {
      label: 'ETH Transfer',
      tx: { from: address || '0x0000000000000000000000000000000000000001', to: '0xRecipient000000000000000000000000000000001', value: '0xde0b6b3a7640000', data: '0x' },
    },
    {
      label: 'Unlimited Approval',
      tx: { from: address || '0x0000000000000000000000000000000000000001', to: '0xTokenContract00000000000000000000000000001', value: '0x0', data: '0x095ea7b3000000000000000000000000abcdef12345678901234567890123456789012345ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff' },
    },
    {
      label: 'Token Transfer',
      tx: { from: address || '0x0000000000000000000000000000000000000001', to: '0xTokenContract00000000000000000000000000001', value: '0x0', data: '0xa9059cbb000000000000000000000000recipient123456789012345678901234567890100000000000000000000000000000000000000000000003635c9adc5dea00000' },
    },
  ];
